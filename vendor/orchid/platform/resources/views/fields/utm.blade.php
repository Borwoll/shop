        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <button type="button" class="btn btn-default" data-bs-toggle="modal"
                        data-bs-target="#utm-{{$id}}">{{__('Генерировать UTM')}}</button>
            </div>
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-black fw-light"
                            id="exampleModalLabel">{{__('Генератор UTM')}}</h4>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link" data-bs-dismiss="modal">{{__('Закрыть')}}</button>
                        <button type="button" data-action="utm#generate" data-bs-dismiss="modal"
                                class="btn btn-default">{{__('Сгенерировать URL-адрес')}}</button>
                    </div>
                </div>
            </div>
        </div>
